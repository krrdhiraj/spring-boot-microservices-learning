...
const Home = () => {
  ...
  const handlePayment = async () => {
    ...
    const response = await axios.post(createOrderApi, {
      amount: 2899,
      courseId: "ecb1339c-2e1b-4333-921e-443d6c768671",
    ...
    //razorpay options
    var options = {
      key: "rzp_test_tdIjPxXZ7scptm", // Enter the Key ID generated from the Dashboard
      amount: createdOrder.amount, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
      currency: "INR",
      name: "Minup - Dhiraj", //your business name
      description: "Learn technical courses online.",
      image:"https://www.learncodewithdurgesh.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdurgesh_sir.35c6cb78.webp&w=1920&q=75",
      ...
      prefill: {
        ...
        name: "Dhiraj Kumar", //your customer's name
        email: "dhiraj@gmail.com",
        contact: "9999999990", //Provide the customer's phone number for better conversion rates
      },
      notes: {
  ...
  return (
    <div>
      ...
      <p>This batch is going to start from 20th April 2025.</p>
